...
{
    this->close(); ///============ 因为ka才加的
    //qDebug() << "oldWidget:" << oldWidget << " nowWidget:" << nowWidget<<"   this->isAncestorOf(nowWidget)                 "<<!this->isAncestorOf(nowWidget);
...
//            }
        ...
        if (currentPosition == "center") {
            ...
            this->setGeometry(0, deskHeight - frmHeight, deskWidth*0.7, frmHeight);
